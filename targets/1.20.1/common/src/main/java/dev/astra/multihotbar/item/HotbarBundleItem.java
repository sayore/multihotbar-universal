...
public final class HotbarBundleItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.multihotbar.hotbar_bundle.hint").withStyle(ChatFormatting.GRAY));
        NonNullList<ItemStack> items = HotbarBundleData.items(stack);
        int active = HotbarBundleData.active(stack);
        tooltip.add(Component.literal("1×  ").withStyle(ChatFormatting.DARK_GRAY)
